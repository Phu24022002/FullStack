<html lang="en">
  ...
  <body>
    ...
    <?php
              ...
              $p = new classck();
              if(isset($_REQUEST["btnthemthang"])){
                $habit_name = $_REQUEST["habit_name"];
                $created_at = $_REQUEST["created_at"];
                $p->themmtthang($habit_name,$created_at);
                echo "<script> window.location='MucTieu.php'</script>";
    ...
    <!--Noi dung-->
    <section class="content" style="height: 30%!important">
      <div class="Chude">
    ...
    <!-- bài làm -->
    <div class="container-custom" style="margin-top:0px !important;">
      <center>
        <h1 class="heading-primary" style="font-size:30px">Quản lý Thói Quen</h1>        
      </center>
        <!-- Nút "Thêm Mục Tiêu Tháng" -->
        <div class="div" style="display:flex;justify-content: space-between;">
          <button class="btn-custom" onclick="toggleForm()" style='margin-top:10px'>Thêm thói quen Tháng</button>
          <form action="#">
            ...
            <input class="btn-custom" style='margin-top:10px' type="submit" value="Recommendations" name="btnthongke">
          </form>
        </div>
        ...
        <div id="habitForm" class="form-custom">
            <form action="#" method="post">
                <label class="label-custom" for="habit_name" style="font-size:18px; margin:6px 0px">Tên thói quen:</label>
                <input class="input-custom" type="text" name="habit_name" required>

                <label class="label-custom" for="created_at" style="font-size:18px; margin:6px 0px">Ngày Thêm:</label>
                <input class="input-custom" id="dateInput" type="date" name="created_at" required>

                <button class="btn-submit-custom" type="submit" name="btnthemthang" style="padding: 5px;">Thêm thói quen</button>
            </form>
        </div>
