<html lang="en">
  <head>
    ...
    <title>Một tháng nhìn lại</title>
  </head>
  ...
  <body>
    ...
    ?>
      ...
      <?php
              ...
              }elseif(isset($_REQUEST["btnthem"])){
                $than = $_REQUEST["than"];
                $tam = $_REQUEST["tam"];
                $tri = $_REQUEST["tri"];

                $p->themnhinlai($than,$tam,$tri);
                echo "<script>alert('Bạn đã nhập một tháng nhìn lại.')</script>";

                echo "<script> window.location='Nhinlai.php'</script>";
              }
...
<div class="form">
    <center><h1 style="color: rgb(80, 191, 255);">MỘT THÁNG NHÌN LẠI</h1>
      <
    </center><br>
    <form action="#" method="get">
        ...
        <center>
          <form action="#" method="get">
              <div class="note">
                <h2>Thân</h2><input value="<?php echo $row["than"]; ?>" type="text"required name="than" id="txtThan" placeholder="Điền vào"><br>
              </div>
              <div class="note">
                <h2>Tâm</h2>
                <input value="<?php echo $row["tam"]; ?>" type="text" name="tam" required id="txttam" placeholder="Điền vào"><br>
              </div>
              <div class="note">
                <h2>Trí</h2>
                <input value="<?php  echo $row["tri"]; ?>" type="text" name="tri" required id="txttri" placeholder="Điền vào"><br>
              </div>
              <div class="submit">
